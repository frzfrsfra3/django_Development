...
class Sub extends BaseControl {
    ...
    {
        this.mainElement.append(`
        <select class="${this.absoluteID(this.IDs.headerElement)}  btn btn-secondary dropdown-toggle" type='' >
...
changeDropdown2(event)
{
    var e = document.querySelector("select." +event +"" );
    e.addEventListener("change",this.dropdowntrigger2(this.absoluteID(v_4.IDs.headerElement)),false)
}
     dropdowntrigger()
     {
